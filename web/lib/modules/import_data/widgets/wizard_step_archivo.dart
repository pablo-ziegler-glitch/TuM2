          ...
          child: Column(
            ...
            children: [
              ...
              _StyledDropdown<DatasetType>(
                ...
                items: DatasetType.values.map((t) => DropdownMenuItem(
                  value: t,
              ...
              _StyledDropdown<String>(
                ...
                items: _zones.map((z) => DropdownMenuItem(
                  value: z,
                  child: Text(z, style: AppTextStyles.bodySm, overflow: TextOverflow.ellipsis),
                )).toList(),
                onChanged: widget.onZoneChanged,
              ),
              const SizedBox(height: 24),
              // Info de configuración completa
              if (widget.selectedDatasetType != null && widget.selectedZone != null)
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.check_circle_outline, color: AppColors.successFg, size: 16),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(
                          'Configuración de origen completa',
                          style: AppTextStyles.bodyXs.copyWith(color: AppColors.successFg),
                        ),
                      ),
                    ],
                  ),
              ...
              GestureDetector(
                ...
                child: MouseRegion(
                  ...
                  child: AnimatedContainer(
                    ...
                    height: 280,
                    decoration: BoxDecoration(
                      color: _isDragOver ? AppColors.primary50 : AppColors.neutral50,
                      borderRadius: BorderRadius.circular(16),
                      border: Border.all(
                        color: _isDragOver ? AppColors.primary500 : AppColors.neutral200,
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          height: 64,
                          decoration: BoxDecoration(
                            color: _isDragOver ? AppColors.primary100 : AppColors.neutral100,
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: Icon(
                            Icons.upload_file_outlined,
                            size: 32,
                            color: _isDragOver ? AppColors.primary500 : AppColors.neutral500,
                          ),
                        ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: DropdownButton<T>(
        ...
        hint: Text(hint, style: AppTextStyles.bodySm.copyWith(color: AppColors.neutral500)),
        items: items,
        onChanged: onChanged,
